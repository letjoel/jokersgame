...
var selectedCoder = newName

function newName(p){
    document.getElementsByClassName(main__first__input)
}

/* use the each() function of jQuery and iterate over each div to get the id and push it into an array.
...
/* para el boton quitar el elemento, podria utilizar un pop():
let sequence = [1, 2, 3];
sequence.push(4);
sequence.push(5);
